...
RUN curl -Lo /etc/yum.repos.d/whitehara-kernel-tkg-preempt-fedora-40.repo https://copr.fedorainfracloud.org/coprs/whitehara/kernel-tkg-preempt/repo/fedora-40/whitehara-kernel-tkg-preempt-fedora-40.repo && \
